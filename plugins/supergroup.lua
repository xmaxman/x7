...
local function lock_group_links(msg, data, target)
  ...
  if group_link_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> 💠#Link posting</code> <b> is #already locked💠</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_link'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠#Link posting</code> <b> has been #locked💠</b>", ok_cb, false)
  end
end
...
local function unlock_group_links(msg, data, target)
  ...
  local group_link_lock = data[tostring(target)]['settings']['lock_link']
  if group_link_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> 💠#Link posting</code> <b> is #not locked💠</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_link'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠#Link posting</code> <b> has been #unlocked💠</b>", ok_cb, false)
  end
end
...
local function lock_group_spam(msg, data, target)
  ...
  if group_spam_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> 💠SuperGroup #spam</code> <b> is #already locked💠</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_spam'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠SuperGroup #spam</code> <b> has been #locked💠</b>", ok_cb, false)
  end
end
...
local function unlock_group_spam(msg, data, target)
  ...
  local group_spam_lock = data[tostring(target)]['settings']['lock_spam']
  if group_spam_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> 💠SuperGroup #spam</code> <b> is #not locked💠</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_spam'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> SuperGroup #spam</code> <b> has been #unlocked</b>", ok_cb, false)
  end
end
...
local function lock_group_flood(msg, data, target)
  ...
  if group_flood_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> #Spamming</code> <b> is #already locked</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['flood'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> #Spamming</code> <b> has been #locked</b>", ok_cb, false)
  end
end
...
local function unlock_group_flood(msg, data, target)
  ...
  local group_flood_lock = data[tostring(target)]['settings']['flood']
  if group_flood_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> #Spamming</code> <b> is #not locked</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['flood'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> #Spamming</code> <b> has been #unlocked</b>", ok_cb, false)
  end
end
...
local function lock_group_arabic(msg, data, target)
  ...
  if group_arabic_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> #Arabic/Persian</code> <b> is #already locked</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_arabic'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> #Arabic/Persian</code> <b> has been #locked</b>", ok_cb, false)
  end
end
...
local function unlock_group_arabic(msg, data, target)
  ...
  local group_arabic_lock = data[tostring(target)]['settings']['lock_arabic']
  if group_arabic_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> #Arabic/Persian</code> <b> is #already unlocked</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_arabic'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> #Arabic/Persian</code> <b> has been #unlocked</b>", ok_cb, false)
  end
end
...
local function lock_group_tag(msg, data, target)
  ...
  if group_tag_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> #Tag</code> <b> is #already locked</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_tag'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> #Tag</code> <b> has been #locked</b>", ok_cb, false)
  end
end
...
local function unlock_group_tag(msg, data, target)
  ...
  local group_tag_lock = data[tostring(target)]['settings']['lock_tag']
  if group_tag_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> #Tag</code> <b> is #already unlocked</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_tag'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> #Tag</code> <b> has been #unlocked</b>", ok_cb, false)
  end
end
...
local function lock_group_webpage(msg, data, target)
  ...
  if group_webpage_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> #WebLink Posting</code> <b> is #already locked!</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_webpage'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> #WebLink posting</code> <b> has been #locked</b>", ok_cb, false)
  end
end
...
local function unlock_group_webpage(msg, data, target)
  ...
  local group_webpage_lock = data[tostring(target)]['settings']['lock_webpage']
  if group_webpage_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> #WebLink Posting</code> <b> is #already unlocked</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_webpage'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> #WebLink posting</code> <b> has been #unlocked</b>", ok_cb, false)
  end
end
...
local function lock_group_fwd(msg, data, target)
  ...
  if group_fwd_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> #Forward Msg</code> <b> is #already locked!</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_fwd'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> #Forward Msg</code> <b> has been #locked</b>", ok_cb, false)
  end
end
...
local function unlock_group_fwd(msg, data, target)
  ...
  local group_fwd_lock = data[tostring(target)]['settings']['lock_fwd']
  if group_fwd_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> #Forward Msg</code> <b> is #already unlocked</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_fwd'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> #Forward Msg</code> <b> has been #unlocked</b>", ok_cb, false)
  end
end
...
local function lock_group_badw(msg, data, target)
  ...
  if group_badw_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> #Badwords</code> <b> is #already locked!</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_badw'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> #Badwords</code> <b> Has been #locked!</b>", ok_cb, false)
  end
end
...
local function unlock_group_badw(msg, data, target)
  ...
  local group_badw_lock = data[tostring(target)]['settings']['lock_badw']
  if group_badw_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> #Badwords</code> <b> is #already unlocked</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_badw'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> #Badwords</code> <b> has been #unlocked</b>", ok_cb, false)
  end
end
...
local function lock_group_emoji(msg, data, target)
  ...
  if group_emoji_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> #Emoji</code> <b> is #already locked!</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_emoji'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> #Emoji</code> <b> Has been #locked!</b>", ok_cb, false)
  end
end
...
local function unlock_group_emoji(msg, data, target)
  ...
  local group_emoji_lock = data[tostring(target)]['settings']['lock_emoji']
  if group_emoji_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> #Emoji is</code> <b> #already unlocked</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_emoji'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> #Emoji</code> <b> has been #unlocked</b>", ok_cb, false)
  end
end
...
local function lock_group_eng(msg, data, target)
  ...
  if group_eng_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> #English</code> <b> is #already locked!</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_eng'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> #English</code> <b> Has been #locked!</b>", ok_cb, false)
  end
end
...
local function unlock_group_eng(msg, data, target)
  ...
  local group_eng_lock = data[tostring(target)]['settings']['lock_eng']
  if group_eng_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> #English</code> <b> is #already unlocked</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_eng'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠#English</code> <b> has been #unlocked</b>", ok_cb, false)
  end
end
local function unlock_group_membermod(msg, data, target)
  ...
  if group_member_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> SuperGroup #members</code> <b> are #not locked</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_member'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> SuperGroup #members</code> <b> has been #unlocked</b>", ok_cb, false)
  end
end
...
local function lock_group_rtl(msg, data, target)
  ...
  if group_rtl_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> #RTL</code> <b> is #already locked</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_rtl'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> #RTL</code> <b> has been #Locked</b>", ok_cb, false)
  end
end
...
local function unlock_group_rtl(msg, data, target)
  ...
  local group_rtl_lock = data[tostring(target)]['settings']['lock_rtl']
  if group_rtl_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> #RTL</code> <b> is #already unlocked</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_rtl'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> #RTL</code> <b> has been #unlocked</b>", ok_cb, false)
  end
end
...
local function lock_group_tgservice(msg, data, target)
  ...
  if group_tgservice_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> #TgService</code> <b> is #already locked</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_tgservice'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> #TGservice</code> <b> has been #locked</b>", ok_cb, false)
  end
end
...
local function unlock_group_tgservice(msg, data, target)
  ...
  local group_tgservice_lock = data[tostring(target)]['settings']['lock_tgservice']
  if group_tgservice_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> #TgService</code> <b> Is #Not Locked!</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_tgservice'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> #TGservice</code> <b> has been #unlocked</b>", ok_cb, false)
  end
end
...
local function lock_group_sticker(msg, data, target)
  ...
  if group_sticker_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> #Sticker posting</code> <b> is #already locked</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_sticker'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> #Sticker posting</code> <b> has been #locked</b>", ok_cb, false)
  end
end
...
local function unlock_group_sticker(msg, data, target)
  ...
  local group_sticker_lock = data[tostring(target)]['settings']['lock_sticker']
  if group_sticker_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> #Sticker posting</code> <b> is #already unlocked</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_sticker'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> #Sticker posting</code> <b> has been #unlocked</b>", ok_cb, false)
  end
end
...
local function lock_group_contacts(msg, data, target)
  ...
  if group_contacts_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> #Contact posting</code> <b> is #already locked</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_contacts'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> #Contact posting</code> <b> has been #locked</b>", ok_cb, false)
  end
end
...
local function unlock_group_contacts(msg, data, target)
  ...
  local group_contacts_lock = data[tostring(target)]['settings']['lock_contacts']
  if group_contacts_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> #Contact posting</code> <b> is #already unlocked</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_contacts'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> #Contact posting</code> <b> has been #unlocked</b>", ok_cb, false)
  end
end
...
local function enable_strict_rules(msg, data, target)
  ...
  if group_strict_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> #Settings </code> <b>are #already strictly enforced</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['strict'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> #Settings </code> <b>will be #strictly_enforced</b>", ok_cb, false)
  end
end
...
local function disable_strict_rules(msg, data, target)
  ...
  local group_strict_lock = data[tostring(target)]['settings']['strict']
  if group_strict_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> #Settings </code> <b>are #not strictly enforced</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['strict'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> #Settings </code><b>will #not be strictly enforced</b>", ok_cb, false)
  end
end
...
local function set_public_membermod(msg, data, target)
  if not is_momod(msg) then
    return reply_msg(msg.id,"<code>💠*For moderators</code> <b> only!💠</b>", ok_cb, false)
  end
  ...
  if group_public_lock == '🔐' then
    return reply_msg(msg.id,"<code>💠*Group is </code> <b>already public💠</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['public'] = '🔐'
    save_data(_config.moderation.data, data)
  end
  return reply_msg(msg.id,"<code>💠*SuperGroup is </code> <b>now: #Public💠</b>", ok_cb, false)
end
...
local function unset_public_membermod(msg, data, target)
  ...
  if group_public_lock == '🔓' then
    return reply_msg(msg.id,"<code>💠*Group is </code> <b>not public💠</b>", ok_cb, false)
  else
    data[tostring(target)]['settings']['public'] = '🔓'
	data[tostring(target)]['long_id'] = msg.to.long_id
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>💠*SuperGroup is </code> <b>now: not public💠</b>",ok_cb,false)
  end
end
