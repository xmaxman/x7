...
local function check_member_super(cb_extra, success, result)
  ...
  for k,v in pairs(result) do
    ...
    if member_id ~= our_id then
      ...
      save_data(_config.moderation.data, data)
	  local text = '<code>💠سوپر گروه اضافه شد!💠</code>'
...
local function check_member_superrem(cb_extra, success, result)
  ...
  for k,v in pairs(result) do
    ...
    if member_id ~= our_id then
      ...
      save_data(_config.moderation.data, data)
	  local text = '<code>💠سوپر گروه حذف شد💠</code>'
      return reply_msg(msg.id, text, ok_cb, false)
    end
  end
end
...
local title ="🌠<b>اطاعات سوپر گروه >></b> ["..result.title.."]\n\n"
local admin_num = "🍀<b>تعداد مدیران >></b> "..result.admins_count.."\n"
local user_num = "🏅<b>تعداد کاربران >></b> "..result.participants_count.."\n"
local kicked_num = "🥇<b>تعداد اخراجیان >></b> "..result.kicked_count.."\n"
local channel_id = "🥉<b>ایدی >></b> "..result.peer_id.."\n"
...
--vardump(result)
local text = "🏅<code>اعضای حذف شده ی سوپر گروه</code> "..cb_extra.receiver.."\n\n> "
local i = 1
for k,v in pairsByKeys(result) do
if not v.print_name then
	name = " "
...
local function lock_group_links(msg, data, target)
  ...
  if group_link_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> 💠قفل لینک از قبل فعال است💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_link'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠قفل لینک فعال شد💠</code>", ok_cb, false)
  end
end
...
local function unlock_group_links(msg, data, target)
  ...
  local group_link_lock = data[tostring(target)]['settings']['lock_link']
  if group_link_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> 💠قفل لینک فعال نیست💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_link'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠قفل لینک غیر فعال شد💠</code>", ok_cb, false)
  end
end
...
local function lock_group_spam(msg, data, target)
  ...
  if group_spam_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> 💠اسپم از قبل فعال است💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_spam'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠اسپم فعال شد💠</code>", ok_cb, false)
  end
end
...
local function unlock_group_spam(msg, data, target)
  ...
  local group_spam_lock = data[tostring(target)]['settings']['lock_spam']
  if group_spam_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> 💠اسپم غیر فعال است💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_spam'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠اسپم غیر فعال شد💠</code>", ok_cb, false)
  end
end
...
local function lock_group_flood(msg, data, target)
  ...
  if group_flood_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> 💠اسپم کردن قفل است💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['flood'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠اسپم کردن قفل شد💠</code>", ok_cb, false)
  end
end
...
local function unlock_group_flood(msg, data, target)
  ...
  local group_flood_lock = data[tostring(target)]['settings']['flood']
  if group_flood_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> 💠اسپم کردن قفل نیست💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['flood'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠اسپم کردن باز شد💠</code>", ok_cb, false)
  end
end
...
local function lock_group_arabic(msg, data, target)
  ...
  if group_arabic_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> 💠عربی و فارسی از قبل قفل است💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_arabic'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠عربی و فارسی قفل شد💠</code>", ok_cb, false)
  end
end
...
local function unlock_group_arabic(msg, data, target)
  ...
  local group_arabic_lock = data[tostring(target)]['settings']['lock_arabic']
  if group_arabic_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> 💠عربی و فارسی قفل نیست💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_arabic'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠عربی و فارسی ازاد شد💠</code>", ok_cb, false)
  end
end
...
local function lock_group_tag(msg, data, target)
  ...
  if group_tag_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> 💠تگ قفل است💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_tag'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠تگ قفل شد💠</code>", ok_cb, false)
  end
end
...
local function unlock_group_tag(msg, data, target)
  ...
  local group_tag_lock = data[tostring(target)]['settings']['lock_tag']
  if group_tag_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> 💠تگ قفل نیست💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_tag'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠تگ ازاد شد💠</code>", ok_cb, false)
  end
end
...
local function lock_group_webpage(msg, data, target)
  ...
  if group_webpage_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> 💠لینک وب فعال است💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_webpage'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠لینک وب فعال شد💠</code>", ok_cb, false)
  end
end
...
local function unlock_group_webpage(msg, data, target)
  ...
  local group_webpage_lock = data[tostring(target)]['settings']['lock_webpage']
  if group_webpage_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> 💠لینک وب فعال نیست💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_webpage'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠لینک وب ازاد شد💠</code>", ok_cb, false)
  end
end
...
local function lock_group_fwd(msg, data, target)
  ...
  if group_fwd_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> 💠قفل فروارد فعال است!💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_fwd'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠قفل فروارد فعال شد💠</code>", ok_cb, false)
  end
end
...
local function unlock_group_fwd(msg, data, target)
  ...
  local group_fwd_lock = data[tostring(target)]['settings']['lock_fwd']
  if group_fwd_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> 💠قفل فروارد فعال نیست💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_fwd'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠قفل فروارد ازاد شد💠</code>", ok_cb, false)
  end
end
...
local function lock_group_badw(msg, data, target)
  ...
  if group_badw_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> 💠قفل فحش فعال است!💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_badw'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠قفل فحش فعال شد!💠</code>", ok_cb, false)
  end
end
...
local function unlock_group_badw(msg, data, target)
  ...
  local group_badw_lock = data[tostring(target)]['settings']['lock_badw']
  if group_badw_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> 💠قفل فحش فعال نیست💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_badw'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠قفل فحش ازاد شد💠</code>", ok_cb, false)
  end
end
...
local function lock_group_emoji(msg, data, target)
  ...
  if group_emoji_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> 💠ایموجی فعال است!💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_emoji'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠ایموجی فعال شد!💠</code>", ok_cb, false)
  end
end
...
local function unlock_group_emoji(msg, data, target)
  ...
  local group_emoji_lock = data[tostring(target)]['settings']['lock_emoji']
  if group_emoji_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> 💠ایموجی فعال نیست💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_emoji'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠ایموجی ازاد شد💠</code>", ok_cb, false)
  end
end
...
local function lock_group_eng(msg, data, target)
  ...
  if group_eng_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> 💠انگلیسی قفل است!💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_eng'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠انگلیسی قفل شد!💠</code>", ok_cb, false)
  end
end
...
local function unlock_group_eng(msg, data, target)
  ...
  local group_eng_lock = data[tostring(target)]['settings']['lock_eng']
  if group_eng_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> 💠انگلیسی قفل نیست💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_eng'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠انگلیسی ازاد شد💠</code>", ok_cb, false)
  end
end
local function unlock_group_membermod(msg, data, target)
  ...
  if group_member_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> 💠اعضای گروه قفل نیست💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_member'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠اعضای گروه ازاد شد💠</code>", ok_cb, false)
  end
end
...
local function lock_group_rtl(msg, data, target)
  ...
  if group_rtl_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> 💠راستچین قفل است💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_rtl'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠راستچین قفل شد💠</code>", ok_cb, false)
  end
end
...
local function unlock_group_rtl(msg, data, target)
  ...
  local group_rtl_lock = data[tostring(target)]['settings']['lock_rtl']
  if group_rtl_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> 💠راستچین قفل نیست💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_rtl'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠راستچین ازاد شد💠</code>", ok_cb, false)
  end
end
...
local function lock_group_tgservice(msg, data, target)
  ...
  if group_tgservice_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> 💠اعلان قفل است💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_tgservice'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠اعلان قفل شد💠</code>", ok_cb, false)
  end
end
...
local function unlock_group_tgservice(msg, data, target)
  ...
  local group_tgservice_lock = data[tostring(target)]['settings']['lock_tgservice']
  if group_tgservice_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> 💠اعلان قفل نیست💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_tgservice'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠اعلان ازاد شد💠</code>", ok_cb, false)
  end
end
...
local function lock_group_sticker(msg, data, target)
  ...
  if group_sticker_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> 💠استیکر قفل است💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_sticker'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠استیکر قفل شد💠</code>", ok_cb, false)
  end
end
...
local function unlock_group_sticker(msg, data, target)
  ...
  local group_sticker_lock = data[tostring(target)]['settings']['lock_sticker']
  if group_sticker_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> 💠استیکر قفل نیست💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_sticker'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠استیکر ازاد شد💠</code>", ok_cb, false)
  end
end
...
local function lock_group_contacts(msg, data, target)
  ...
  if group_contacts_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> 💠مخاطب قفل است💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_contacts'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠مخاطب قفل شد💠</code>", ok_cb, false)
  end
end
...
local function unlock_group_contacts(msg, data, target)
  ...
  local group_contacts_lock = data[tostring(target)]['settings']['lock_contacts']
  if group_contacts_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> 💠مخاطب قفل نیست💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_contacts'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠مخاطب ازاد شد💠</code>", ok_cb, false)
  end
end
...
local function enable_strict_rules(msg, data, target)
  ...
  if group_strict_lock == '🔐' then
    return reply_msg(msg.id,"<code>>> 💠تنظیمات سخت گیرانه فعال است💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['strict'] = '🔐'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠تنظیمات سخت گیرانه فعال شد💠</code>", ok_cb, false)
  end
end
...
local function disable_strict_rules(msg, data, target)
  ...
  local group_strict_lock = data[tostring(target)]['settings']['strict']
  if group_strict_lock == '🔓' then
    return reply_msg(msg.id,"<code>>> 💠تنظیمات سخت گیرانه غیر فعال است💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['strict'] = '🔓'
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>>> 💠تنظیمات سخت گیرانه غیر فعال شد💠</code>", ok_cb, false)
  end
end
...
local function set_public_membermod(msg, data, target)
  ...
  if group_public_lock == '🔐' then
    return reply_msg(msg.id,"<code>💠گروه از قبل عمومی است💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['public'] = '🔐'
    save_data(_config.moderation.data, data)
  end
  return reply_msg(msg.id,"<code>💠حالا گروه عمومی شد💠</code>", ok_cb, false)
end
...
local function unset_public_membermod(msg, data, target)
  ...
  if group_public_lock == '🔓' then
    return reply_msg(msg.id,"<code>💠گروه عمومی نیست💠</code>", ok_cb, false)
  else
    data[tostring(target)]['settings']['public'] = '🔓'
	data[tostring(target)]['long_id'] = msg.to.long_id
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"<code>💠گروه از حالت عمومی در امده شده میباشد💠</code>",ok_cb,false)
  end
end
